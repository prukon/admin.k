...
<div class="modal fade" id="modalTbankInfo" tabindex="-1" aria-labelledby="modalTbankInfoLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Платёжный модуль T‑Банка позволяет принимать оплату от родителей прямо в CRM. Укажите ключи и пароли
                    из личного кабинета эквайринга: отдельно для приёма платежей и, при необходимости, для выплат
                    партнёру (e2c). Включите тестовый режим, чтобы проверить сценарии без списания реальных денег.
                </p>
            </div>
            <div class="modal-footer">
                <button class="btn btn-secondary" data-bs-dismiss="modal">Закрыть</button>
