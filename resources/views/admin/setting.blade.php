    ...
    <div class=" col-md-12 main-content text-start" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="container">
            <div class="row justify-content-md-center">
                    ...
                    <div class="modal-dialog d-flex justify-content-center">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-start">
                                <button type="button" class="btn btn-secondary mb-3" id="addMenuItem">Новый пункт меню
                                </button>
                ...
                <div class="modal fade mt-3 socialMenuModal" id="socialMenuModal" tabindex="-1" aria-labelledby="socialMenuModalLabel">
                    <div class="modal-dialog d-flex justify-content-center">
                        <div class="modal-content">
                            <div class="modal-header">
