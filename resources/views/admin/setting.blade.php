                    ...
                    <table class="table table-bordered mt-5 settings-table">
                        ...
                        <tr>
                            ...
                            <td class="col-6 align-middle text-center">
                                <button type="button" class="btn btn-primary fixed-width-btn width-160" id="logs"
                        ...
                        <tr>
                            ...
                            <td class="col-6 align-middle text-center">
                                <a href="/payment/service" id="club-fee"
                                   class="btn btn-primary fixed-width-btn width-160">Перейти к оплате</a>
                            </td>
                        </tr>
