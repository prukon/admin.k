...
@php $canChangeTrainerPassword = auth()->user()->can('users.password.update'); @endphp
                    ...
                    <table class="table table-striped align-middle">
                        ...
                        @foreach($trainers as $t)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($u && $u->image_crop)
                                        <img src="{{ asset('storage/avatars/' . $u->image_crop) }}"
                                             alt=""
                                             class="rounded"
                                ...
                                <td class="text-end">
                                    <button type="button"
                                            class="btn btn-sm btn-outline-primary js-trainer-edit"
                                            data-id="{{ $t->id }}">
                                        Редактировать
                                    </button>
                                </td>
                ...
                <div class="modal-body">
                    <form id="trainerCreateForm" class="text-start">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" for="trainer-create-is-enabled">Активен</label>
                                    <select class="form-select" name="is_enabled" id="trainer-create-is-enabled">
...
@section('scripts')
    ...
    <script>
        (function () {
            ...
            function handleSaveResponse(form, ok, status, data) {
                if (ok) {
            ...
            document.querySelectorAll('.js-trainer-edit').forEach(btn => {
            ...
            document.getElementById('trainerEditSubmit')?.addEventListener('click', async () => {
                ...
                handleSaveResponse(editForm, ok, status, data);
            });
