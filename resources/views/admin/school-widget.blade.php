...
@section('content')
    <div class="main-content text-start">
        <h4 class="pt-3">Виджет заявок</h4>
        <p class="text-muted">Скопируйте код и вставьте его на лендинг (Tilda, Wix, HTML-страницу).</p>
        <hr>
        ...
        <div class="container" style="max-width: 900px;">
            ...
            {{-- <div class="alert alert-info">
                UTM-метки с адреса страницы партнёра подхватываются автоматически, если их передать в URL iframe
                (например: <code>?utm_source=google&utm_campaign=spring</code>).
            </div> --}}
            ...
            @if ($telegramConfigured)
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        {{-- <p class="text-muted small mt-3 mb-0" id="telegramConnectHint">
                            Нажмите «Подключить Telegram» → откроется бот → нажмите <strong>«Старт»</strong>.
                            Chat ID сохранится автоматически. Затем обновите эту страницу.
                        </p> --}}
