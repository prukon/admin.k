                        ...
                        <div id="usersImportMemo"
                            ...
                            <div class="accordion-body users-import-memo text-muted">
                                ...
                                <ul class="mb-0 ps-3">
                                    ...
                                    <li>Одинаковый email родителя → один родитель. Пустые ячейки ФИО/телефона <b>не трогают</b> справочник; непустые <b>дописываются</b> в пустые поля карточки. Конфликт — только если в файле и в справочнике оба значения заполнены и различаются.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
