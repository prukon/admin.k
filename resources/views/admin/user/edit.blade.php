...
{{--                        <input type="date" name="birthday" class="form-control" id="birthday" value="{{ old('birthday', $user->birthday) }}">--}}
                        <input type="date" name="birthday" class="form-control" id="birthday" value="{{ old('birthday', $user->birthday) }}" max="{{ date('Y-m-d') }}">
...
{{--                        <input type="date" name="start_date" class="form-control" id="start_date" value="{{ old('start_date', $user->start_date) }}">--}}
                        <input type="date" name="start_date" class="form-control" id="start_date" value="{{ old('start_date', $user->start_date) }}" max="{{ date('2030-01-01') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="email" type="email" class="form-control" id="email" placeholder="name@example.com" value="{{ old('email', $user->email) }}">
                        @error('email')
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="is_enabled" class="form-control" id="activity">
                            <option value="0" {{ old('is_enabled', $user->is_enabled) == 0 ? 'selected' : '' }}>Неактивен</option>
                            <option value="1" {{ old('is_enabled', $user->is_enabled) == 1 ? 'selected' : '' }}>Активен</option>
                        </select>
                        @error('is_enabled')
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Обработчик модалки для удаления
