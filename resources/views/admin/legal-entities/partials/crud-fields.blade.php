...
<div class="row g-3">
    <div class="col-md-6">
        ...
        <select name="business_type" class="form-select js-legal-entity-sm-locked" required>
    ...
    <div class="col-md-6">
        ...
        <input class="form-control js-legal-entity-sm-locked" name="title" required value="{{ $field('title') }}" />
        <div class="invalid-feedback d-block" data-error-for="title"></div>
    </div>

    <div class="col-md-12">
        <label class="form-label">Наименование организации</label>
        <input class="form-control js-legal-entity-sm-locked" name="organization_name" value="{{ $field('organization_name') }}" />
    ...
    <div class="col-12">
        <h6 class="mb-0 mt-1">Реквизиты для sm-register</h6>
    </div>
    ...
    <div class="col-md-6">
        ...
        <input class="form-control js-legal-entity-sm-locked" name="sms_name" maxlength="14" value="{{ $field('sms_name') }}" />
        <div class="form-text">До 14 символов, латиница (A–Z, 0–9, пробел, <code>.-_</code>).</div>
        <div class="invalid-feedback d-block" data-error-for="sms_name"></div>
    </div>
    ...
    <div class="col-12">
        <h6 class="mb-0 mt-1">Данные руководителя / ИП</h6>
    </div>
    ...
    <div class="col-md-6">
        ...
        <div class="invalid-feedback d-block" data-error-for="taxation_system"></div>
    </div>
