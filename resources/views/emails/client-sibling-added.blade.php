...
<head>
    <meta charset="UTF-8">
    <title>Семейный кабинет | kidscrm.online</title>
</head>
...
<p>
    В &quot;{{ $partnerTitle }}&quot; на сервисе kidscrm.online добавлен ученик
    <strong>{{ $student->full_name ?: trim($student->name . ' ' . $student->lastname) }}</strong>.
</p>

<p>
    Отдельный логин для него не создавался: войдите в личный кабинет под уже выданным доступом
    семьи и переключите ученика в сайдбаре («Просмотр данных ученика»).
</p>
...
<table cellpadding="0" cellspacing="0" style="margin: 16px 0; border-collapse: collapse;">
    <tr>
        ...
        <td style="padding: 6px 0;"><strong>{{ $familyLoginUser->email }}</strong></td>
    </tr>
</table>
...
<p style="color: #555; font-size: 14px;">
    Пароль тот же, что вы получали ранее. Если вы не ожидали это письмо, свяжитесь с администрацией
    &quot;{{ $partnerTitle }}&quot;.
</p>
