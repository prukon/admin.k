...
@section('title', 'Оплата принята')

@section('content')
    <div class="container">
        <h1 class="h4 mb-3">Оплата принята</h1>
        <p class="mb-2">Спасибо! Платёж зарегистрирован.</p>
        <p class="text-muted small mb-3" id="tbankReturnRedirectMsg"></p>
        <p class="mb-0">
            <a href="#" id="tbankReturnGoNow" class="btn btn-primary btn-sm">Перейти сейчас</a>
        </p>
    </div>
@endsection
