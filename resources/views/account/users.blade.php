                    ...
                    <div class="col-12 col-lg-6 user-data-wrap mb-3">
                        ...
                        <form id ='userUpdateForm' method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <select  class="form-control" id="team" name="team_id" @cannot('changing-your-group') disabled @endcannot>
                            ...
                            <div class="mb-3">
                                ...
                                <select  name="is_enabled" class="form-control" id="activity" @cannot('changing-user-activity') disabled @endcannot>
