...
@section('title', 'CRM для секции единоборств — онлайн-оплаты без абонплаты | kidscrm.online')

@section('meta_description',
    'CRM для секции единоборств и школы боевых искусств: онлайн-оплаты, учёт абонементов, долгов, учеников, групп, расписания и договоров. Без абонентской платы, без своей онлайн-кассы и без отдельного эквайринга.')

@section('content')

    <div class="landing-page martial-arts-landing">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 mb-3 mb-md-4">
                        <div class="text-center mb-2">
                            <span class="section-label">CRM для секций единоборств</span>
                        </div>

                        <h1 class="fw-bold text-center mb-3">
                            <span class="mark-creative">CRM для школы единоборств с онлайн-оплатами без абонплаты</span>
                        </h1>

                        <p class="text-center mb-2" style="font-size: 1.08rem;">
                            Помогаем секциям единоборств собирать оплаты вовремя, видеть долги по абонементам
                    ...
                    <div class="col-md-6 mb-4 mb-md-0 d-flex flex-column">
                        ...
                        <ul class="list-unstyled mt-3 mb-3 mb-md-4">
                            ...
                            <li class="d-flex align-items-start mb-2">
                                <img src="{{ asset('img/landing/icons/check-mark.png') }}"
                                    ...
                                    alt="Онлайн-оплаты для секции единоборств">
                        ...
                        <div class="small text-muted mb-3 mb-md-4">
                            Подходит для школ бокса, каратэ, дзюдо, тхэквондо, самбо, ММА и других секций боевых искусств.
                        </div>
                        ...
                        <div class="d-flex flex-column flex-md-row align-items-center gap-3">
                            ...
                            <div class="small text-muted text-center text-md-start">
                                Покажем за 15 минут, как это будет работать именно в вашей секции
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 d-flex justify-content-center align-items-center mt-4 mt-md-0">
                        <img src="{{ asset('img/landing/martial-arts.png') }}"
                            alt="CRM для секции единоборств"
                            class="img-fluid"
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-xl-11">
                        ...
                        <h2 class="text-center mb-3">
                            <span class="mark-creative">Почему в секции единоборств быстро начинается хаос с оплатами</span>
                        </h2>

                        <p class="text-center text-muted fs-5 mb-4">
                            Когда учеников и групп становится больше, ручной учёт начинает отнимать слишком много времени.
                        </p>
                                ...
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <li class="d-flex mb-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-muted">
                                                Кто-то оплатил абонемент, кто-то переводит частями, кто-то обещал позже —
                                    ...
                                    <li class="d-flex mb-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-muted">
                                                Сложно быстро понять, кто должен, за какой месяц и по какой группе.
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="d-flex mb-0">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-muted">
                                                Такая схема неудобна, непрозрачна и плохо подходит для секции, которая хочет расти системно.
                                            </div>
                                        </div>
                                    </li>
        ...
        <section id="solution" class="py-5 bg-light">
            <div class="container">
                ...
                <h2 class="text-center mb-3">
                    <span class="mark-creative">Как kidscrm.online помогает школе единоборств</span>
                </h2>

                <p class="text-center text-muted fs-5 mb-4">
                    Вы занимаетесь тренировочным процессом. Система берёт на себя оплату, учёт долгов и порядок в базе.
                </p>
                        ...
                        <div class="card border-0 shadow-lg rounded-4 bg-white card-soft">
                            <div class="card-body p-4 p-md-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="p-3 p-md-4 h-100 rounded-4 bg-light">
                                            ...
                                            <div class="text-muted small">
                                                Родители получают ссылку на оплату, а секция видит статусы и долги.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="h-100 p-3 p-md-4 rounded-4 bg-light">
                                            <h5 class="fw-bold mb-2">Учёт секции</h5>
                                            <ul class="text-muted small mb-0 ps-3">
                                ...
                                <div class="text-center mt-4">
                                    <a href="#registration-form"
                                        ...
                                        data-bs-toggle="modal"
                                        data-bs-target="#createOrder">
                                        Посмотреть демо для секции единоборств
                                    </a>
                                </div>
        ...
        <!-- ЗАТОЧЕНО ПОД ЕДИНОБОРСТВА -->
        <section class="py-5 bg-light">
            <div class="container">

                <div class="text-center mb-2">
                    <span class="section-label">Подходит для единоборств</span>
                </div>

                <h2 class="text-center mb-3">
                    <span class="mark-creative">Что особенно важно для секции боевых искусств</span>
                </h2>

                <p class="text-center text-muted fs-5 mb-5">
                    В школе единоборств обычно есть абонементы, разные возрастные группы, тренеры,
                    аттестации, экипировка и дополнительные сборы. Всё это удобнее вести в одной системе.
                </p>
                        ...
                        <div class="card border-0 shadow-lg rounded-4 bg-white card-soft">
                            <div class="card-body p-4 p-md-5">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="h-100 p-4 rounded-4 bg-light">
                                            <h5 class="fw-bold mb-2">Группы и тренеры</h5>
                                            <p class="text-muted small mb-0">
                                                Ученики, тренеры, расписание и группы — в одном месте.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="h-100 p-4 rounded-4 bg-light">
                                            ...
                                            <p class="text-muted small mb-0">
                                                Можно учитывать экипировку, аттестации, соревнования и другие платежи отдельно.
                                            </p>
                                        </div>
                                    </div>
        ...
        <section id="how-it-works" class="py-5 bg-light">
            <div class="container">
                ...
                <h2 class="text-center mb-4">
                    <span class="mark-creative">Подключаем секцию под ключ</span>
                </h2>
                ...
                @php
                    $steps = [
                        [
                            ...
                            'title' => 'Заявка',
                            'desc' => 'Вы показываете, как сейчас устроены оплаты и учёт в вашей секции.',
                        ],
                        [
                        ...
                        [
                            ...
                            'desc' => 'Вы видите, кто оплатил, кто должен и какая картина по секции.',
                        ],
                    ];
            ...
            <div class="container">
                ...
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-lg-9">
                        ...
                        <h2 class="mb-3">
                            <span class="mark-creative">Что есть в CRM для секции единоборств</span>
                        </h2>

                        <p class="text-muted fs-5 mb-0">
                            Всё основное для оплаты, учёта учеников и управления секцией в одном кабинете.
                        </p>
                                    ...
                                    <div class="col-md-4 text-center mb-4 mb-md-0">
                                        <div class="border rounded-4 shadow-sm p-2 bg-light">
                                            <img src="{{ asset('img/landing/dashboard.png') }}"
                                                alt="Панель управления секцией единоборств"
                                    ...
                                    <div class="col-md-4">
                                        @foreach ([
                                            [
                                                ...
                                                'desc' => 'Единая база учеников, родителей, групп и тренеров.',
                                            ],
                                            [
                            ...
                            <div class="card-body p-4 p-md-5">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 text-end mob-hide">
                                        <img src="{{ asset('img/landing/martial-arts.png') }}"
                                            alt="Преимущества CRM для школы единоборств"
                                    ...
                                    <div class="col-md-8 mb-4 mb-md-0">
                                        ...
                                        <h2 class="text-center mb-5" id="advantages">
                                            <span class="mark-creative">Почему школы единоборств выбирают kidscrm.online</span>
                                        </h2>
        ...
        <section id="audience" class="py-5 bg-light">
            <div class="container">
                ...
                <h2 class="text-center mb-3">
                    <span class="mark-creative">Для каких направлений единоборств подходит CRM</span>
                </h2>

                <p class="text-center text-muted mb-5 fs-5">
                    Решение подходит секциям, где есть группы, абонементы, регулярные оплаты и работа с родителями.
                </p>
                            ...
                            <div class="card-body p-4 p-md-5">
                                <div class="row g-4 text-center text-md-start">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="p-4 bg-light rounded-4 h-100">
                                            <h5 class="fw-bold mb-2">Бокс и кикбоксинг</h5>
                                            <p class="text-muted small mb-0">
                                                Регулярные тренировки, абонементы и понятный учёт оплат.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="p-4 bg-light rounded-4 h-100">
                                            <h5 class="fw-bold mb-2">Каратэ, тхэквондо, дзюдо</h5>
                                            <p class="text-muted small mb-0">
                                                Группы, тренеры, расписание и прозрачный контроль задолженностей.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="p-4 bg-light rounded-4 h-100">
                                            <h5 class="fw-bold mb-2">Самбо и ММА</h5>
                                            <p class="text-muted small mb-0">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="p-4 bg-light rounded-4 h-100">
                                            <h5 class="fw-bold mb-2">Секции с несколькими группами</h5>
                                            <p class="text-muted small mb-0">
                                                Когда таблиц уже много и нужен единый порядок в секции.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="text-center mt-4">
                                    <a href="#registration-form"
                                        ...
                                        data-bs-toggle="modal"
                                        data-bs-target="#createOrder">
                                        Узнать, подойдёт ли это моей секции
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <section id="faq" class="py-5 bg-light">
            <div class="container">
                ...
                <h2 class="text-center mb-4">FAQ для секций единоборств</h2>
                        ...
                        <div class="card border-0 shadow-lg rounded-4 bg-white card-soft">
                            <div class="card-body p-4 p-md-5">
                                <div class="accordion" id="faqAccordion">
                                    @foreach ([
                                        'Подходит ли сервис для секции единоборств?' => 'Да. Сервис подходит школам и секциям единоборств, где есть группы, абонементы, расписание, тренеры и регулярные оплаты от родителей.',
                                        'Можно ли учитывать доплаты, кроме абонемента?' => 'Да. Можно учитывать отдельные платежи: экипировку, аттестации, соревнования, сборы и другие доплаты.',
        ...
        <section id="cta" class="py-5 bg-call-to-action">
            <div class="container text-center">
                <h2 class="display-6 fw-bold mb-3">
                    Хотите навести порядок в оплатах секции единоборств?
                </h2>

                <p class="fs-5 mb-3">
                    Покажем, как <span class="fw-bold">kidscrm.online</span> поможет вашей секции
                ...
                <a href="#registration-form"
                    ...
                    data-bs-toggle="modal"
                    data-bs-target="#createOrder"
                    data-analytics="cta_bottom_demo_martial_arts">
