...
@section('meta_description', 'CRM для школы единоборств: учет учеников, расписание тренировок, оплаты, долги и онлайн-договоры. Без абонплаты, комиссия 2% с успешных оплат. Запуск за 1 день.')
