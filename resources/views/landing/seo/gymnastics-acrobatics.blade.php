...
@section('title', 'CRM для школы гимнастики и акробатики — онлайн-оплаты без абонплаты | kidscrm.online')

@section('meta_description',
    'CRM для школ гимнастики и акробатики: онлайн-оплаты, учёт абонементов, долгов, учеников, групп, расписания и договоров. Без абонентской платы, без своей онлайн-кассы и без отдельного эквайринга.')

@section('content')

    <div class="landing-page gymnastics-landing">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 mb-3 mb-md-4">
                        <div class="text-center mb-2">
                            <span class="section-label">CRM для школ гимнастики и акробатики</span>
                        </div>

                        <h1 class="fw-bold text-center mb-3">
                            <span class="mark-creative">CRM для школы гимнастики с онлайн-оплатами без абонплаты</span>
                        </h1>

                        <p class="text-center mb-2" style="font-size: 1.08rem;">
                            Помогаем школам гимнастики и акробатики собирать оплаты вовремя, видеть долги по абонементам
                    ...
                    <div class="col-md-6 mb-4 mb-md-0 d-flex flex-column">
                        ...
                        <ul class="list-unstyled mt-3 mb-3 mb-md-4">
                            ...
                            <li class="d-flex align-items-start mb-2">
                                <img src="{{ asset('img/landing/icons/check-mark.png') }}"
                                     ...
                                     alt="Онлайн-оплаты для школы гимнастики">
                        ...
                        <div class="small text-muted mb-3 mb-md-4">
                            Подходит для школ спортивной и художественной гимнастики, акробатики и детских секций.
                        </div>
                    ...
                    <div class="col-md-6 d-flex justify-content-center align-items-center mt-4 mt-md-0">
                        <img src="{{ asset('img/landing/gymnastics.png') }}"
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-xl-11">
                        ...
                        <h2 class="text-center mb-3">
                            <span class="mark-creative">Почему в школе гимнастики быстро начинается хаос с оплатами</span>
                        </h2>

                        <p class="text-center text-muted fs-5 mb-4">
                            Когда групп и учеников становится больше, ручной учёт начинает мешать нормальной работе школы.
                        </p>
        ...
        <section id="solution" class="py-5 bg-light">
            <div class="container">
                ...
                <h2 class="text-center mb-3">
                    <span class="mark-creative">Как kidscrm.online помогает школе гимнастики</span>
                </h2>
                            ...
                            <div class="card-body p-4 p-md-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="p-3 p-md-4 h-100 rounded-4 bg-light">
                                            ...
                                            <div class="text-muted small">
                                                Родители получают ссылку на оплату, а школа видит статусы и долги.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="text-center mt-4">
                                    <a href="#registration-form"
                                       ...
                                       data-bs-toggle="modal"
                                       data-bs-target="#createOrder">
                                        Посмотреть демо для школы гимнастики
                                    </a>
                                </div>
        ...
        <!-- ЗАТОЧЕНО ПОД ГИМНАСТИКУ -->
        <section class="py-5 bg-light">
            <div class="container">

                <div class="text-center mb-2">
                    <span class="section-label">Подходит для гимнастики и акробатики</span>
                </div>

                <h2 class="text-center mb-3">
                    <span class="mark-creative">Что особенно важно для школ гимнастики и акробатики</span>
                </h2>

                <p class="text-center text-muted fs-5 mb-5">
                    В таких школах обычно есть абонементы, группы по возрастам, тренеры, сборы, соревнования,
                    экипировка и доплаты. Всё это удобнее вести в одной системе.
                </p>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="h-100 p-4 rounded-4 bg-light">
                                            ...
                                            <p class="text-muted small mb-0">
                                                Можно учитывать соревнования, экипировку, сборы и другие платежи отдельно.
                                            </p>
                                        </div>
                                    </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-lg-9">
                        ...
                        <h2 class="mb-3">
                            <span class="mark-creative">Что есть в CRM для школы гимнастики</span>
                        </h2>
                                    ...
                                    <div class="col-md-4 text-center mb-4 mb-md-0">
                                        <div class="border rounded-4 shadow-sm p-2 bg-light">
                                            <img src="{{ asset('img/landing/dashboard.png') }}"
                                                 alt="Панель управления школой гимнастики"
                            ...
                            <div class="card-body p-4 p-md-5">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 text-end mob-hide">
                                        <img src="{{ asset('img/landing/gymnastics.png') }}"
                                             alt="Преимущества CRM для школы гимнастики"
                                    ...
                                    <div class="col-md-8 mb-4 mb-md-0">
                                        ...
                                        <h2 class="text-center mb-5" id="advantages">
                                            <span class="mark-creative">Почему школы гимнастики выбирают kidscrm.online</span>
                                        </h2>
        ...
        <section id="audience" class="py-5 bg-light">
            <div class="container">
                ...
                <h2 class="text-center mb-3">
                    <span class="mark-creative">Для каких школ гимнастики и акробатики подходит CRM</span>
                </h2>
                                ...
                                <div class="row g-4 text-center text-md-start">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="p-4 bg-light rounded-4 h-100">
                                            <h5 class="fw-bold mb-2">Спортивная гимнастика</h5>
                                            <p class="text-muted small mb-0">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="p-4 bg-light rounded-4 h-100">
                                            <h5 class="fw-bold mb-2">Художественная гимнастика</h5>
                                            <p class="text-muted small mb-0">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="p-4 bg-light rounded-4 h-100">
                                            <h5 class="fw-bold mb-2">Акробатика</h5>
                                            <p class="text-muted small mb-0">
        ...
        <section id="faq" class="py-5 bg-light">
            <div class="container">
                ...
                <h2 class="text-center mb-4">FAQ для школ гимнастики и акробатики</h2>
                        ...
                        <div class="card border-0 shadow-lg rounded-4 bg-white card-soft">
                            <div class="card-body p-4 p-md-5">
                                <div class="accordion" id="faqAccordion">
                                    @foreach ([
                                        'Подходит ли сервис для школы гимнастики и акробатики?' => 'Да. Сервис подходит школам гимнастики и акробатики, где есть группы, абонементы, расписание, тренеры и регулярные оплаты от родителей.',
                                        'Можно ли учитывать доплаты, кроме абонемента?' => 'Да. Можно учитывать отдельные платежи: соревнования, экипировку, сборы, мероприятия и другие доплаты.',
        ...
        <section id="cta" class="py-5 bg-call-to-action">
            <div class="container text-center">
                <h2 class="display-6 fw-bold mb-3">
                    Хотите навести порядок в оплатах школы гимнастики?
                </h2>
                ...
                <a href="#registration-form"
                   ...
                   data-bs-toggle="modal"
                   data-bs-target="#createOrder"
                   data-analytics="cta_bottom_demo_gymnastics">
