...
@section('title', 'CRM для детской языковой школы — учет учеников, расписание и оплаты | kidscrm.online')
@section('meta_description', 'CRM для детской языковой школы: учет учеников и групп, расписание занятий, оплаты, долги и онлайн-договоры. Без абонплаты, комиссия 2% с успешных оплат. Запуск за 1 день.')
