...
@section('title', 'CRM для танцевальной студии и школы танцев — онлайн-оплаты без абонплаты | kidscrm.online')

@section('meta_description',
    'CRM для танцевальной студии и школы танцев: онлайн-оплаты, учёт абонементов, долгов, учеников, расписания и договоров. Без абонентской платы, без своей онлайн-кассы и без отдельного эквайринга.')

@section('content')

    <div class="landing-page dance-landing">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 mb-3 mb-md-4">
                        <div class="text-center mb-2">
                            <span class="section-label">CRM для танцевальных студий</span>
                        </div>

                        <h1 class="fw-bold text-center mb-3">
                            <span class="mark-creative">CRM для танцевальной студии с онлайн-оплатами без абонплаты</span>
                        </h1>

                        <p class="text-center mb-2" style="font-size: 1.08rem;">
                            Помогаем школам танцев собирать оплаты вовремя, видеть долги по абонементам
                            и держать учеников, расписание и платежи в одной системе.
                        </p>
                    ...
                    <div class="col-md-6 mb-4 mb-md-0 d-flex flex-column">
                        ...
                        <ul class="list-unstyled mt-3 mb-3 mb-md-4">
                            ...
                            <li class="d-flex align-items-start mb-2">
                                <img src="{{ asset('img/landing/icons/check-mark.png') }}"
                                    ...
                                    alt="Онлайн-оплаты для танцевальной студии">
                                <span>Онлайн-оплаты за абонементы и занятия</span>
                            </li>
                        ...
                        <div class="small text-muted mb-3 mb-md-4">
                            Подходит для танцевальных студий, школ танцев, хореографических направлений и детских танцевальных секций.
                        </div>
                        ...
                        <div class="d-flex flex-column flex-md-row align-items-center gap-3">
                            ...
                            <div class="small text-muted text-center text-md-start">
                                Покажем за 15 минут, как это будет работать именно в вашей студии
                            </div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-xl-11">
                        ...
                        <h2 class="text-center mb-3">
                            <span class="mark-creative">Почему в танцевальной студии быстро начинается хаос с оплатами</span>
                        </h2>

                        <p class="text-center text-muted fs-5 mb-4">
                            Когда учеников становится больше, Excel, переписки и ручной учёт начинают тормозить рост студии.
                        </p>
                                ...
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <li class="d-flex mb-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-muted">
                                                Кто-то оплатил абонемент, кто-то обещал позже, кто-то внёс часть суммы —
                                                и всё это приходится собирать вручную.
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="d-flex mb-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-muted">
                                                Администратор тратит время на сверки, а руководитель не видит ситуацию по группам и ученикам в одном окне.
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="d-flex mb-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-muted">
                                                Напоминания, сообщения родителям, проверка переводов и ответы на вопросы по оплатам съедают часы каждую неделю.
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="d-flex mb-0">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-muted">
                                                Такая схема неудобна, непрозрачна и плохо масштабируется для студии, которая хочет расти спокойно.
                                            </div>
                                        </div>
                                    </li>
        ...
        <section id="solution" class="py-5 bg-light">
            <div class="container">
                ...
                <h2 class="text-center mb-3">
                    <span class="mark-creative">Как kidscrm.online помогает танцевальной студии</span>
                </h2>

                <p class="text-center text-muted fs-5 mb-4">
                    Вы ведёте занятия и развиваете студию. Система берёт на себя оплату, учёт долгов и порядок в базе.
                </p>
                        ...
                        <div class="card border-0 shadow-lg rounded-4 bg-white card-soft">
                            <div class="card-body p-4 p-md-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="p-3 p-md-4 h-100 rounded-4 bg-light">
                                            ...
                                            <div class="text-muted small">
                                                Родители получают понятную ссылку на оплату, а студия видит статусы и долги.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="h-100 p-3 p-md-4 rounded-4 bg-light">
                                            <h5 class="fw-bold mb-2">Учёт студии</h5>
                                            <ul class="text-muted small mb-0 ps-3">
                                                <li>ученики, группы, расписание;</li>
                                                <li>абонементы и долги;</li>
                                                <li>история оплат;</li>
                                ...
                                <div class="text-center mt-4">
                                    <a href="#registration-form"
                                        ...
                                        data-bs-toggle="modal"
                                        data-bs-target="#createOrder">
                                        Посмотреть демо для студии танцев
                                    </a>
                                </div>
        ...
        <section class="py-5 bg-light">
            <div class="container">
                ...
                <div class="text-center mb-2">
                    <span class="section-label">Подходит для студий танцев</span>
                </div>

                <h2 class="text-center mb-3">
                    <span class="mark-creative">Что особенно важно для школы танцев</span>
                </h2>

                <p class="text-center text-muted fs-5 mb-5">
                    В танцевальной студии обычно есть абонементы, разные группы, преподаватели, выступления и допсборы.
                    Всё это удобнее вести в одной системе.
                </p>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="h-100 p-4 rounded-4 bg-light">
                                            <h5 class="fw-bold mb-2">Абонементы</h5>
                                            <p class="text-muted small mb-0">
                                                Видно, кто оплатил месяц, а у кого просрочка или частичный долг.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="h-100 p-4 rounded-4 bg-light">
                                            <h5 class="fw-bold mb-2">Группы и расписание</h5>
                                            <p class="text-muted small mb-0">
                                                Ученики, группы, преподаватели и занятия — в одном месте.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="h-100 p-4 rounded-4 bg-light">
                                            <h5 class="fw-bold mb-2">Доплаты и сборы</h5>
                                            <p class="text-muted small mb-0">
                                                Можно учитывать костюмы, выступления, сборы и другие платежи отдельно.
                                            </p>
                                        </div>
                                    </div>
        ...
        <section id="how-it-works" class="py-5 bg-light">
            <div class="container">
                ...
                <h2 class="text-center mb-4">
                    <span class="mark-creative">Подключаем студию под ключ</span>
                </h2>
                ...
                @php
                    $steps = [
                        [
                            ...
                            'title' => 'Заявка',
                            'desc' => 'Вы показываете, как сейчас устроены оплаты и учёт в студии.',
                        ],
                        [
                        ...
                        [
                            ...
                            'desc' => 'Помогаем задать абонементы, цены и нужные типы платежей.',
                        ],
                        [
                        ...
                        [
                            ...
                            'desc' => 'Вы видите, кто оплатил, кто должен и какая картина по студии.',
                        ],
                    ];
            ...
            <div class="container">
                ...
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-lg-9">
                        ...
                        <h2 class="mb-3">
                            <span class="mark-creative">Что есть в CRM для танцевальной студии</span>
                        </h2>

                        <p class="text-muted fs-5 mb-0">
                            Всё основное для оплаты, учёта учеников и управления студией в одном кабинете.
                        </p>
                                    ...
                                    <div class="col-md-4 mb-4 mb-md-0">
                                        @foreach ([
                                            [
                                                ...
                                                'text' => 'Приём оплат',
                                                'desc' => 'Онлайн-оплаты от родителей и автоматическая фиксация платежей.',
                                            ],
                                            [
                                    ...
                                    <div class="col-md-4 text-center mb-4 mb-md-0">
                                        <div class="border rounded-4 shadow-sm p-2 bg-light">
                                            <img src="{{ asset('img/landing/dashboard.png') }}"
                                                alt="Панель управления танцевальной студией"
                            ...
                            <div class="card-body p-4 p-md-5">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 text-end mob-hide">
                                        <img src="{{ asset('img/landing/dance.png') }}"
                                            alt="Преимущества CRM для школы танцев"
                                    ...
                                    <div class="col-md-8 mb-4 mb-md-0">
                                        ...
                                        <h2 class="text-center mb-5" id="advantages">
                                            <span class="mark-creative">Почему танцевальные студии выбирают kidscrm.online</span>
                                        </h2>
        ...
        <section id="audience" class="py-5 bg-light">
            <div class="container">
                ...
                <h2 class="text-center mb-3">
                    <span class="mark-creative">Для каких танцевальных направлений подходит CRM</span>
                </h2>

                <p class="text-center text-muted mb-5 fs-5">
                    Решение подходит студиям, где есть группы, абонементы, регулярные оплаты и работа с родителями.
                </p>
                            ...
                            <div class="card-body p-4 p-md-5">
                                <div class="row g-4 text-center text-md-start">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="p-4 bg-light rounded-4 h-100">
                                            <h5 class="fw-bold mb-2">Детские студии танцев</h5>
                                            <p class="text-muted small mb-0">
                                                Регулярные занятия, абонементы и работа с родителями.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="p-4 bg-light rounded-4 h-100">
                                            <h5 class="fw-bold mb-2">Хореографические школы</h5>
                                            <p class="text-muted small mb-0">
                                                Группы, преподаватели, расписание и прозрачный учёт оплат.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="p-4 bg-light rounded-4 h-100">
                                            <h5 class="fw-bold mb-2">Студии современных танцев</h5>
                                            <p class="text-muted small mb-0">
                                                Удобно вести абонементы, долги и дополнительные сборы.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="p-4 bg-light rounded-4 h-100">
                                            ...
                                            <p class="text-muted small mb-0">
                                                Когда таблиц уже много и нужен единый порядок в студии.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="text-center mt-4">
                                    <a href="#registration-form"
                                        ...
                                        data-bs-toggle="modal"
                                        data-bs-target="#createOrder">
                                        Узнать, подойдёт ли это моей студии
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <section id="faq" class="py-5 bg-light">
            <div class="container">
                ...
                <h2 class="text-center mb-4">FAQ для школ танцев</h2>
                        ...
                        <div class="card border-0 shadow-lg rounded-4 bg-white card-soft">
                            <div class="card-body p-4 p-md-5">
                                <div class="accordion" id="faqAccordion">
                                    @foreach ([
                                        'Подходит ли сервис для танцевальной студии?' => 'Да. Сервис подходит студиям и школам танцев, где есть группы, абонементы, расписание, преподаватели и регулярные оплаты от родителей.',
                                        'Можно ли учитывать доплаты, кроме абонемента?' => 'Да. Можно учитывать отдельные платежи: костюмы, выступления, сборы, мероприятия и другие доплаты.',
        ...
        <section id="cta" class="py-5 bg-call-to-action">
            <div class="container text-center">
                <h2 class="display-6 fw-bold mb-3">
                    Хотите навести порядок в оплатах танцевальной студии?
                </h2>

                <p class="fs-5 mb-3">
                    Покажем, как <span class="fw-bold">kidscrm.online</span> поможет вашей студии
                    собирать оплаты вовремя и убрать ручной хаос из учёта.
                </p>

                <p class="fs-5 fw-semibold mb-4">
                    На демо покажем, как это будет работать именно под вашу структуру групп и абонементов.
                </p>
                ...
                <a href="#registration-form"
                    ...
                    data-bs-toggle="modal"
                    data-bs-target="#createOrder"
                    data-analytics="cta_bottom_demo_dance">
