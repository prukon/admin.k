...
@section('meta_description', 'CRM для футбольной секции: учет учеников и команд, расписание тренировок, оплаты, долги и онлайн-договоры. Без абонплаты, комиссия 2% с успешных оплат. Запуск за 1 день.')
            ...
            @php
                $footballFaq = [
                    ...
                    'Есть ли абонентская плата?' =>
                        'Нет. Абонентская плата — 0 ₽. Оплата сервиса взимается только как комиссия 2% с успешных транзакций.',
