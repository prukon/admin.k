        ...
        <div class="container">
            ...
            <div class="accordion" id="faqAccordion">
                @foreach([
                    ...
                    'Какие способы оплаты поддерживаются?' => 'Поддерживаются онлайн-оплаты через эквайринг. Мы берём комиссию только с успешных транзакций — без абонентской платы.',
                    'Насколько безопасны мои данные?' => 'Данные защищены, доступ настраивается по ролям, а все изменения фиксируются. При необходимости поможем с переносом и проверкой данных.'
                ] as $question => $answer)
