...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            ...
            ['name' => "user@user.ru",              'team_id' => null, 'birthday' => "1989-06-01",     'start_date' => "2018-07-22", 'email' => "user@user.ru" ,                         'is_enabled' => 1,    'image_crop' => "",                             'created_at' => "2018-07-22 16:01:00",     'role' => 'user',   'password' => '$2y$12$nC02CRQ7SJ85bd89/Qoh7eYvTaWOMiIytU3p9B1.xACMzAgrefUNK', ],
