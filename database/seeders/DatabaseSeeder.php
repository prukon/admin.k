...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            ...
            ['name' => "admin@admin.ru",            'team_id' => null, 'birthday' => '1989-06-01',  'start_date' => "2024-02-22", 'email' => "admin@admin.ru",                        'is_enabled' => 1,    'image_crop' => "",                             'created_at' => "2018-02-22 10:38:00",     'role' => 'admin',  'password' => '$2y$12$wI.nc4BT.Uek3z2CShmQn.gBxRvX8D0cIFm6dWyG3SWPfFH3u6Jea', ],
            ['name' => "user@user.ru",              'team_id' => null, 'birthday' => "1989-06-01",  'start_date' => "2024-07-22", 'email' => "user@user.ru" ,                         'is_enabled' => 1,    'image_crop' => "",                             'created_at' => "2018-07-22 16:01:00",     'role' => 'user',   'password' => '$2y$12$nC02CRQ7SJ85bd89/Qoh7eYvTaWOMiIytU3p9B1.xACMzAgrefUNK', ],
