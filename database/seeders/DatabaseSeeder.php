...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            ...
            ['name' => "Белявский Елисей",          'team_id' => 4, 'birthday' => "2013-01-14",     'start_date' => "2018-11-12", 'email' => "germina99@mail.ru",                     'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2018-11-12 17:37:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Павлов Александр",          'team_id' => 4, 'birthday' => "2011-10-26",     'start_date' => "2018-11-12", 'email' => "glamm32@gmail.com",                     'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2018-11-12 18:06:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Атамян Артур",              'team_id' => 5, 'birthday' => "2020-08-17",     'start_date' => "2019-04-08", 'email' => "test17@mail.ru",                        'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2019-04-08 11:57:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Журавель Артем",            'team_id' => 4, 'birthday' => "2020-09-01",     'start_date' => "2019-09-06", 'email' => "test126@mail.ru",                       'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2019-09-06 11:06:00",     'role' => 'user',   'password' => '', ],
            ['name' => "Шевцов Ерёма",              'team_id' => 4, 'birthday' => "2011-11-15",     'start_date' => "2019-09-06", 'email' => "9666411@bk.ru",                         'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2019-09-06 11:17:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Чайковский Илья",           'team_id' => 4, 'birthday' => "2019-10-06",     'start_date' => "2019-09-19", 'email' => "test175@mail.ru",                       'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2019-09-19 16:41:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Белявский Тимофей",         'team_id' => 4, 'birthday' => "2010-11-30",     'start_date' => "2019-10-03", 'email' => "test182@mail.ru",                       'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2019-10-03 13:32:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Ильин Матвей",              'team_id' => 5, 'birthday' => "2019-10-01",     'start_date' => "2019-10-05", 'email' => "test191@mail.ru",                       'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2019-10-05 20:45:00",     'role' => 'user',   'password' => '', ],
            ['name' => "Савилов Кирилл",            'team_id' => 1, 'birthday' => "2011-04-15",     'start_date' => "2020-01-23", 'email' => "test205@mail.ru",                       'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2020-01-23 12:25:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Коршиков Артём",            'team_id' => 2, 'birthday' => "2012-08-02",     'start_date' => "2020-09-14", 'email' => "vk-ppk@yandex.ru",                      'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2020-09-14 21:00:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Мячин Лука",                'team_id' => 1, 'birthday' => null,             'start_date' => "2020-09-25", 'email' => "test403@mail.ru",                       'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2020-09-25 13:20:00",     'role' => 'user',   'password' => '', ],
            ['name' => "Никишов Вячеслав",          'team_id' => 1, 'birthday' => "2009-01-21",     'start_date' => "2020-09-25", 'email' => "test433@mail.ru",                       'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2020-09-25 14:24:00",     'role' => 'user',   'password' => '', ],
            ['name' => "Карсаков Елисей",           'team_id' => 5, 'birthday' => "2013-01-06",     'start_date' => "2020-11-05", 'email' => "test480@mail.ru",                       'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2020-11-05 19:48:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Антадзе Сандро",            'team_id' => 4, 'birthday' => null,             'start_date' => "2021-09-29", 'email' => "test740@mail.ru",                       'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2021-09-29 19:59:00",     'role' => 'user',   'password' => '', ],
            ['name' => "Акимов Кирилл",             'team_id' => 2, 'birthday' => "2021-10-01",     'start_date' => "2021-09-29", 'email' => "p9219004159@yandex.ru",                 'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2021-09-29 20:10:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Антадзе Дато",              'team_id' => 1, 'birthday' => null,             'start_date' => "2021-12-20", 'email' => "test888@mail.ru",                       'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2021-12-20 13:55:00",     'role' => 'user',   'password' => '', ],
            ['name' => "Павлов Савелий",            'team_id' => 2, 'birthday' => "2011-07-09",     'start_date' => "2022-09-06", 'email' => "seregamarkx@mail.ru",                   'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2022-09-06 17:47:00",     'role' => 'user',   'password' => '', ],
            ['name' => "Шмаков Сергей",             'team_id' => 5, 'birthday' => null,             'start_date' => "2022-09-06", 'email' => "test1008@mail.ru",                      'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2022-09-06 17:49:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Лаврентьев Роман",          'team_id' => 2, 'birthday' => "2023-02-26",     'start_date' => "2022-09-22", 'email' => "test1020@mail.ru",                      'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2022-09-22 17:58:00",     'role' => 'user',   'password' => '', ],
            ['name' => "Антадзе Авто",              'team_id' => 4, 'birthday' => null,             'start_date' => "2022-10-02", 'email' => "test1027@mail.ru",                       'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2022-10-02 9:12:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Игнатенко Дима",            'team_id' => 3, 'birthday' => null,             'start_date' => "2022-10-04", 'email' => "test1042@mail.ru",                      'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2022-10-04 10:30:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Бальский Павел",            'team_id' => 5, 'birthday' => "2013-08-07",     'start_date' => "2022-10-06", 'email' => "o.balskaya@yandex.ru",                  'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2022-10-06 21:28:00",     'role' => 'user',   'password' => '', ],
            ['name' => "Мардашов Вячеслав",         'team_id' => 2, 'birthday' => "2024-04-02",     'start_date' => "2022-10-20", 'email' => "test1060@mail.ru",                      'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2022-10-20 16:11:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Бушуев Никита",             'team_id' => 2, 'birthday' => null,             'start_date' => "2023-04-20", 'email' => "test1082@mail.ru",                      'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2023-04-20 12:21:00",     'role' => 'user',   'password' => '', ],
            ['name' => "Сильванович Семен",         'team_id' => 5, 'birthday' => "2012-12-25",     'start_date' => "2023-05-18", 'email' => "test1091@mail.ru",                      'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2023-05-18 10:57:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Малышенков Павел",          'team_id' => 5, 'birthday' => "2023-07-21",     'start_date' => "2023-09-12", 'email' => "test1502@mail.ru",                      'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2023-09-12 20:04:00",     'role' => 'user',   'password' => '', ],
            ...
            ['name' => "Сандалкин Владимир",        'team_id' => 3, 'birthday' => null,             'start_date' => "2024-01-16", 'email' => "sandalkinvladimir@sandalkinvladimir.ru",'is_enabled' => 1,    'image_crop' => "", 'created_at' => "2024-01-16 15:16:00",     'role' => 'user',   'password' => '', ],
