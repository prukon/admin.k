...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'reports.emails.view',            'description' => 'Страница "Исходящие письма"',                  'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 16],
            ...
            ['name' => 'lessonPackages.manualPaid.manage', 'description' => 'Абонементы: ручная отметка оплаты назначения', 'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 36],
            ['name' => 'districts.view',                 'description' => 'Справочники: районы (просмотр и редактирование)', 'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 36],
            ['name' => 'locations.view',                 'description' => 'Справочники: объекты (просмотр)',               'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 37],
            ['name' => 'locations.manage',               'description' => 'Справочники: объекты (создание/редактирование)', 'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 38],
            ['name' => 'sport_types.view',             'description' => 'Страница "Виды спорта"',                          'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 39],
            ['name' => 'sport_types.manage',           'description' => 'Виды спорта: создание/редактирование',          'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 40],
            ['name' => 'trainers.view',                  'description' => 'Страница "Тренеры"',                            'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 41],
            ...
            ['name' => 'groups.training_base.view',      'description' => 'Группы: поле «Тренировочная база»',             'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 51],
            ['name' => 'groups.address.view',            'description' => 'Группы: поле «Адрес»',                          'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 52],
            ...
            ['name' => 'contracts.templates.fillSortOrder.edit', 'description' => 'Шаблоны договоров: редактировать порядок полей в форме родителя', 'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 53],
            ...
            ['name' => 'account.contracts.showFieldKeys', 'description' => 'Договор (форма): показывать технические ключи полей {{...}}', 'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 71],
            ...
            ['name' => 'partnerLeads.view',              'description' => 'Страница "Лиды партнёров"',                     'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 75],
            ['name' => 'schoolLeads.view',               'description' => 'Страница "Заявки с сайта"',                     'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 76],
            ['name' => 'schoolWidget.view',              'description' => 'Страница "Виджет заявок"',                      'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 77],
            ['name' => 'schoolLeadLanding.view',         'description' => 'Страница заявки (CRM)',                         'group_slug' => 'mainMenu', 'is_visible' => 0, 'sort_order' => 78],
