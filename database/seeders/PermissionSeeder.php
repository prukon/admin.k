...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'reports.payments.totals.platform_commission.view', 'description' => 'Отчёт «Платежи»: итог комиссии платформы в шапке', 'group_slug' => 'reports', 'is_visible' => 0, 'sort_order' => 20],
            ['name' => 'reports.payments.commission_total.view', 'description' => 'Отчёт «Платежи»: колонка «Комиссия» (сводно)', 'group_slug' => 'reports', 'is_visible' => 0, 'sort_order' => 21],
            ...
            ['name' => 'locations.view',                 'description' => 'Справочники: объекты (просмотр)',               'group_slug' => 'directories', 'is_visible' => 0, 'sort_order' => 37],
            ...
            ['name' => 'account.partner.view',           'description' => 'Страница "Учетная запись -> Организация"',      'group_slug' => 'account',  'is_visible' => 0, 'sort_order' => 70],
            ...
            ['name' => 'account.user.phone.verify',      'description' => 'ЛК: подтверждение телефона (SMS)',               'group_slug' => 'account',  'is_visible' => 0, 'sort_order' => 61],
            ['name' => 'account.user.two_factor.update', 'description' => 'ЛК: двухфакторная аутентификация (SMS)',         'group_slug' => 'account',  'is_visible' => 0, 'sort_order' => 62],
            ...
            ['name' => 'users.discount.manage',         'description' => 'Персональная скидка ученика (процент и основание в CRM)', 'group_slug' => 'users', 'is_visible' => 1, 'sort_order' => 7],
            ['name' => 'users.import',                  'description' => 'Импорт учеников из Excel',                       'group_slug' => 'users',    'is_visible' => 0, 'sort_order' => 5],
            ['name' => 'users.full_name_genitive',      'description' => 'ФИО ученика в родительном падеже (CRM, ЛК, импорт Excel)', 'group_slug' => 'users', 'is_visible' => 0, 'sort_order' => 6],
            ...
            ['name' => 'viewing.all.logs',               'description' => 'Просмотр всех логов',                            'group_slug' => 'settings', 'is_visible' => 0, 'sort_order' => 210],
            ...
            ['name' => 'settings.systemMonitors.view',   'description' => 'Системные мониторы (оверлеи)',                     'group_slug' => 'settings', 'is_visible' => 0, 'sort_order' => 224],
