...
/**
 * Скрытое право account.user.phone.verify (группа account).
 * Не входит в base roles: при создании партнёра выключено у всех.
 * Superadmin включает в матрице. Без права кнопка «Подтвердить» в ЛК скрыта.
 */
return new class extends Migration
{
    private const PERMISSION_NAME = 'account.user.phone.verify';
    ...
    public function up(): void
    {
        ...
        DB::table('permissions')->upsert(
            [[
                ...
                'description'         => 'ЛК: подтверждение телефона (SMS)',
