...
/**
 * Добавляет невидимое право settings.cabinetDiagnostics.manage (группа settings).
 * Ролям не выдаётся — по умолчанию никому недоступно (в т.ч. для существующих партнёров).
 * Кнопка и оверлей проверяют hasPermission() напрямую: Gate::before у superadmin не открывает UI.
 */
    ...
    public function up(): void
    {
        ...
        DB::table('permissions')->upsert(
            [[
                ...
                'description'         => 'Диагностика консоли (/cabinet)',
