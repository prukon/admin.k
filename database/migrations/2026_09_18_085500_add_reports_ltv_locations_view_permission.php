...
/**
 * Право reports.ltv.locations.view: вкладка «Платежи по объектам».
 * Видимое. Существующим партнёрам не выдаётся — только новым через role_base_permissions.
 */
return new class extends Migration
{
    private const PERMISSION_NAME = 'reports.ltv.locations.view';
    ...
    public function up(): void
    {
        ...
        DB::table('permissions')->upsert(
            [[
                ...
                'description' => 'Отчёт «Платежи по объектам»',
