...
/**
 * Скрытое право contracts.lessonPackage.bind — выбор абонемента при создании договора.
...
{
    private const PERMISSION_NAME = 'contracts.lessonPackage.bind';

    public function up(): void
    {
        $now = Carbon::now();
        $groupId = DB::table('permission_groups')->where('slug', 'contracts')->value('id');

        DB::table('permissions')->upsert(
            [[
                'name'                => self::PERMISSION_NAME,
                'description'         => 'Договоры: выбор абонемента при создании',
