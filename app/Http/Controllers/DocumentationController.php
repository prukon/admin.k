...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'lesson-packages'             => 'Абонементы: шаблоны (автосписание), дубль в «Справочниках», назначения, выгрузка Excel (lessonPackages.export), календарь',
        'school-schedule-calendar'    => 'Расписание школы: календарь, inline-панели, выгрузка Excel (листы Занятия/Назначения), JSON/API',
