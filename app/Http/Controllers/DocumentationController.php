...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'lesson-packages'             => 'Абонементы: шаблоны, назначения, период с календаря, конфликт fixed по starts_at, статусы, выгрузка Excel',
        ...
        'schedule-journal'            => 'Журнал расписания: /schedule, lesson_occurrence_statuses (toolbar/DataTable/история), тренер при «Посетил»',
