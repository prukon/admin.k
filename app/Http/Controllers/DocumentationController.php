...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'settings-permission-groups'  => 'Матрица прав: группы permissions (permission_groups), аккордеон «Права и роли», группа «Оплата платформы» (platformPayments.method.*), ховер возможностей права (иконка i)',
        ...
        'reports-payments'            => 'Отчёт «Платежи»: payments.team_id (колонка/фильтр), «Поля списка», «Показать N» (page_length), поиск DataTables только ФИО и группа (§1.2), права, история T‑Bank; ФИО = payments.user_id (семья — выбранный ребёнок)',
