...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'chat' => 'Чат CRM (Сообщения): 1-на-1 внутри школы, бейдж badge-info без вспышки в открытом диалоге, messages.view в базовых ролях, Reverb без wsPath, оверлей статуса процесса/сокета для superadmin, онлайн-точка и галочки исходящего в списке',
