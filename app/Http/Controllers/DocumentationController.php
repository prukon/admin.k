...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'admin-users'                 => 'Ученики (админка): /admin/users только role=user, родители, колонка «Договор», мед./особенности, пол (users.sex — CRM и кабинет), комментарий (users.comment), группа',
        ...
        'school-leads-widget'         => 'Заявки с сайта: виджет iframe, CRM, статусы с цветными бейджами, inline-смена в таблице, лид→клиент→договор, Telegram',
