...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'reports-admin'               => 'Отчёты (админка): KidsCrmDataTable, columns-settings, «Показать N» (page_length), закрепление thead и горизонтального скролла payments/monthly/LTV/debts/intents/fiscal/tbank/emails (§1.3), поиск DataTables payments/LTV/monthly/intents (§1.2), «Платежи T‑Bank» (Чек / комиссия платформы без additional.value.view, фильтр «Не было выплаты», вид Платежи/По дням/По месяцам), «Исходящие письма» (модалка, iframe HTML, mailable_class из Mailable / X-Mailable-Class; Laravel 10 сам ключ не ставит; пульт Welcome), фильтры, AJAX/суммы',
        ...
        'tbank'                       => 'T‑Bank (мультирасчёты): глобальный терминал, комиссии, автовыплата, карточка платежа (организация, timeline), вкладка отчётов «Платежи T‑Bank» (Чек / комиссия платформы, фильтр «Не было выплаты», вид Платежи/По дням/По месяцам), пульт Касса CONFIRMED без выплаты после задержки партнёра (не фильтр without_payout), СБП (QR); публичные /pm и /p без логина — не /tinkoff/qr',
        ...
        'setting-prices-monthly-users' => 'Установка цен: бывшие участники, корзина неоплаченного начисления бывшего, персональная скидка, sync users_prices↔ULP, ручная пролонгация месяца на следующий, ручная оплата с абонементом/суммой из карточки, плашка группы только вместе со списком учеников',
        ...
        'contract-templates'          => 'Шаблоны DOCX: fields_schema, {{contract_date}} / системные поля, разрывы Word w:t, «Юр. лицо», email («По умолчанию» → {{documents_url}}), версии',
        'account-contract-fill'       => 'Заполнение договора родителем: fill/generate/sign, каунтер активных договоров в сайдбаре и на вкладке «Мои документы», авто {{contract_date}}, юрлицо группы, ключ Подпислона юрлица, ссылка на подпись из SMS на карточке документов, паспорт (серия и номер), fallback parent_email, ошибки Laravel под полями, колокольчик админам при signed (не после revoked), приглашение на users.email и parents.email (дедуп), семейная ссылка ?student=&fill=',
