...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'schedule-journal'            => 'Журнал /schedule: раскладка fixed/flexible, разовое пишет user_lesson_packages.team_id, статусы, мультитренеры при «Посетил» (pivot → ЗП/нагрузка)',
