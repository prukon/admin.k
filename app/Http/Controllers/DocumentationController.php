...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'settings-permission-groups'  => 'Матрица прав: группы permissions (permission_groups), аккордеон «Права и роли», группа «Расписание школы» (schoolSchedule), группа «Оплата платформы» (platformPayments.method.*), ховер возможностей права (иконка i), скрытое account.user.two_factor.update (SMS-2FA в ЛК)',
