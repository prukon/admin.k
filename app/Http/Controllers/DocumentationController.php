...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'partners-permissions'        => 'Партнёры: базовые роли и права; опциональные (customPayments, account.user.team.update, скрытая группа schoolSchedule, …); скрытое account.user.two_factor.update не в base roles (SMS-2FA в ЛК по умолчанию выкл.)',
        ...
        'settings-permission-groups'  => 'Матрица прав: группы permissions (permission_groups), аккордеон «Права и роли», группа «Расписание школы» (schoolSchedule), группа «Оплата платформы» (platformPayments.method.*), ховер возможностей права (иконка i), скрытое account.user.two_factor.update (SMS-2FA в ЛК), скрытое contracts.fillExpiresAt.view (колонка «Срок подписания»)',
