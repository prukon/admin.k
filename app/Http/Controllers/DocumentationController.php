...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'partners-permissions'        => 'Партнёры: базовые роли и права; опциональные (customPayments, account.user.team.update, …)',
        ...
        'lesson-packages'             => 'Абонементы: шаблоны, назначения (фильтр «Удаленные» / soft-deleted), автопролонгация fixed, billing_month / период, ends_at, конфликт fixed, статусы, Excel',
        ...
        'schedule-journal'            => 'Журнал /schedule: раскладка fixed/flexible, статусы, мультитренеры при «Посетил» (pivot → ЗП/нагрузка)',
        ...
        'parents-and-family-cabinet'  => 'Родители и семейный кабинет: parents, parent_id, переключение детей, добавление группы (account.user.team.update), active_student',
        'dashboard-cabinet'           => 'Консоль (/cabinet): блоки оплат, сезоны, добавление группы в ЛК (account.user.team.update)',
