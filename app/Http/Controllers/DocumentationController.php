...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'contracts'                   => 'Договоры (клиентские): PDF и режим «форма клиенту», создание со списка клиентов/заявок (lockUser), блок без юрлица группы, ЭП Подпислона с ключа юрлица (не PODPISLON_API_KEY), карточка, revoke/refund, аннулирование sent/opened без возврата 70 ₽ (signed PDF при revoked, без колокольчика), вкладка «Шаблоны», колокольчик админам при signed, колонка «Договор» = иконка PDF при signed_pdf_path (скачать в новой вкладке), колонка «Обновлён» = последнее событие журнала (не contracts.updated_at)',
