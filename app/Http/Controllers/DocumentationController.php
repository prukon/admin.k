...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'reports-admin'               => 'Отчёты (админка): KidsCrmDataTable, columns-settings, «Показать N» (page_length), закрепление thead и горизонтального скролла payments/monthly/LTV/debts/intents/fiscal/tbank/emails (§1.3), поиск DataTables payments/LTV/monthly/intents (§1.2), «Платежи T‑Bank» (Чек / комиссия платформы без additional.value.view, фильтр «Не было выплаты», колонка «Статус выплаты», вид Платежи/По дням/По месяцам, дефолт CONFIRMED на По дням/По месяцам), «Исходящие письма» (модалка, iframe HTML, mailable_class из Mailable / X-Mailable-Class; Laravel 10 сам ключ не ставит; пульт Welcome), фильтры, AJAX/суммы',
        ...
        'tbank'                       => 'T‑Bank (мультирасчёты): глобальный терминал, комиссии (кнопка История / logModal, Колонки / persist N), автовыплата, карточка платежа (организация, timeline), вкладка отчётов «Платежи T‑Bank» (Чек / комиссия платформы, фильтр «Не было выплаты», колонка «Статус выплаты», вид Платежи/По дням/По месяцам, дефолт CONFIRMED на По дням/По месяцам), пульт Касса CONFIRMED без выплаты после задержки партнёра (не фильтр without_payout), СБП (QR); публичные /pm и /p без логина — не /tinkoff/qr',
