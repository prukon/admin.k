...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'location-team-bindings'      => 'Объекты ↔ группы (location_team): привязки, расписание, отчёты; users.location_id удалён',
        'directories-hierarchy'       => 'Справочники: иерархия Район → Объект → Группа (обзор, права, БД, лендинг, CRM)',
        'admin-districts'             => 'Районы (админка): /admin/districts — districts.view, CRUD, hard delete, лендинг',
        'admin-locations'             => 'Объекты (админка): /admin/locations — view/manage, district_id, team_ids',
        'admin-sport-types'           => 'Виды спорта (админка): /admin/sport-types — sport_types.view/manage, teams.sport_type_id, лендинг',
        'admin-teams'                 => 'Группы (админка): /admin/teams — groups.view, month_price, training_base/address, объекты, тренер, расписание',
        ...
        'admin-users'                 => 'Пользователи (админка): /admin/users, родители, колонка и фильтр «Договор», мед./особенности, группа (без users.location_id)',
