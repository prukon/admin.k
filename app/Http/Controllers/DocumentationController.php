...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'setting-prices-monthly-users' => 'Установка цен: бывшие участники, корзина неоплаченного начисления бывшего, персональная скидка, sync users_prices↔ULP, замена предоплаты в разложенном/оплаченном месяце, ручная пролонгация месяца на следующий, ручная оплата с абонементом/суммой из карточки, плашка группы только вместе со списком учеников',
