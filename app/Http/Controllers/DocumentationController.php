...
class DocumentationController extends Controller
{
    ...
    private const PAGE_TITLES = [
        ...
        'contract-templates'          => 'Шаблоны DOCX: модалки, fields_schema, переменные «Юр. лицо» / child_address, fill_sort_order, email, версии',
        'account-contract-fill'       => 'Заполнение договора родителем: кабинет, fill/generate/sign, sync профиля, реквизиты юрлица группы',
