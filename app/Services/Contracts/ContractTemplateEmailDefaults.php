...
final class ContractTemplateEmailDefaults
{
    ...
    public static function bodyHtml(): string
    {
        return '<p>Здравствуйте!</p>'
            ...
            . '<p>Откройте договор в кабинете, заполните поля в простой форме — данные сами подставятся в текст договора. '
            . 'Когда всё проверите, подпишите договор <strong>прямо в личном кабинете</strong>.</p>'
