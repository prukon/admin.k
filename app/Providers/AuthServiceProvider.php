...
////////////////////////ГЛАВНОЕ МЕНЮ//////////////////////
        ...
        // Отчёты -> вкладка "Платежи по группам"
        Gate::define('reports.ltv.teams.view', function (User $user) {
        ...
        Gate::define('scheduleSlots.table', function (User $user) {
            return $user->hasPermission('scheduleSlots.table');
        });
        ...
        Gate::define('lessonPackages.manualPaid.manage', function (User $user) {
        ...
        // Юр. лица
        Gate::define('legal_entities.view', function (User $user) {
            return $user->hasPermission('legal_entities.view');
        });
        ...
        Gate::define('users.import', function (User $user) {
        ...
        // Страница "Лиды партнёров"
        Gate::define('partnerLeads.view', function (User $user) {
            return $user->hasPermission('partnerLeads.view');
        });

        Gate::define('schoolLeads.view', function (User $user) {
            return $user->hasPermission('schoolLeads.view');
        });

        Gate::define('schoolWidget.view', function (User $user) {
            return $user->hasPermission('schoolWidget.view');
        });

        Gate::define('schoolLeadLanding.view', function (User $user) {
            return $user->hasPermission('schoolLeadLanding.view');
        });
