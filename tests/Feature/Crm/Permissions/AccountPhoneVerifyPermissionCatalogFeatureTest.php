 ...
 */
final class AccountPhoneVerifyPermissionCatalogFeatureTest extends CrmTestCase
{
    private const PERMISSION = 'account.user.phone.verify';

    private const DESCRIPTION = 'ЛК: подтверждение телефона (SMS)';
    ...
    public function test_permission_exists_hidden_in_account_group(): void
    {
        ...
        $this->assertSame(61, (int) $row->sort_order);
    }
    ...
    public function test_add_migration_creates_hidden_permission_without_role_backfill(): void
    {
        $src = (string) file_get_contents(base_path(
            'database/migrations/2026_09_13_004500_add_account_user_phone_verify_permission.php'
        ));
