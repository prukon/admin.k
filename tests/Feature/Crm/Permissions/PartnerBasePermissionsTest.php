...
class PartnerBasePermissionsTest extends CrmTestCase
{
    ...
    public function test_new_partner_does_not_assign_custom_payments_view_to_base_roles(): void
    {
        ...
        $this->assertNotContains('messages.own.delete', $userPerms);
        $this->assertNotContains('messages.own.delete', $adminPerms);
        $this->assertNotContains('messages.own.delete', $trainerPerms);
        $this->assertNotContains('partner.oferta.pdf', $userPerms);
        $this->assertNotContains('partner.oferta.pdf', $adminPerms);
        $this->assertNotContains('partner.oferta.pdf', $trainerPerms);
    ...
    public function test_new_partner_does_not_assign_school_schedule_permissions_to_base_roles(): void
    {
        $partner = Partner::factory()->create();
    ...
    public function test_new_partner_does_not_assign_lesson_packages_type_permissions_to_base_roles(): void
    {
        $partner = Partner::factory()->create();
    ...
    public function test_new_partner_does_not_assign_account_user_phone_verify_to_base_roles(): void
    {
        $partner = Partner::factory()->create();
        ...
        $this->assertNotContains('account.user.phone.verify', $userPerms);
        $this->assertNotContains('account.user.phone.verify', $adminPerms);
        $this->assertNotContains('account.user.phone.verify', $trainerPerms);
    }

    public function test_new_partner_does_not_assign_groups_own_to_base_roles(): void
    {
        $partner = Partner::factory()->create();
        ...
        $this->assertNotContains('groups.own', $userPerms);
        $this->assertNotContains('groups.own', $adminPerms);
        $this->assertNotContains('groups.own', $trainerPerms);
    }
    ...
    public function test_new_partner_does_not_assign_reports_payments_commission_total_to_base_roles(): void
    {
        ...
        $this->assertNotContains('reports.payments.commission_total.view', $userPerms);
        $this->assertNotContains('reports.payments.commission_total.view', $adminPerms);
        $this->assertNotContains('reports.payments.commission_total.view', $trainerPerms);
    }
