...
/**
 * contracts.fillExpiresAt.view: скрытое, не в базовых ролях, колонка «Срок подписания».
 */
final class ContractsFillExpiresAtPermissionCatalogFeatureTest extends CrmTestCase
{
    private const PERMISSION = 'contracts.fillExpiresAt.view';

    private const DESCRIPTION = 'Договоры: колонка «Срок подписания»';
    ...
    public function test_permission_exists_hidden_in_contracts_group(): void
    {
        ...
        $this->assertSame(54, (int) $row->sort_order);
    }
    ...
    public function test_add_migration_creates_hidden_permission_without_role_backfill(): void
    {
        $src = (string) file_get_contents(base_path(
            'database/migrations/2026_09_12_062900_add_contracts_fill_expires_at_view_permission.php'
        ));
