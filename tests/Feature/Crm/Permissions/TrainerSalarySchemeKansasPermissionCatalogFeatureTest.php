...
/**
 * Каталог права schedule.trainerSalary.scheme.kansas: скрытое, не в базовых ролях.
 */
final class TrainerSalarySchemeKansasPermissionCatalogFeatureTest extends CrmTestCase
{
    private const PERMISSION_NAME = 'schedule.trainerSalary.scheme.kansas';

    private const DESCRIPTION = 'ЗП тренеров: схема «Канзас» (оклад за тренировку + премия от среднего)';
    ...
    public function test_permission_exists_in_schedule_group_hidden(): void
    {
        ...
        $this->assertNotNull($row, 'Право schedule.trainerSalary.scheme.kansas должно существовать');
        ...
        $this->assertSame(29, (int) $row->sort_order);
    }
