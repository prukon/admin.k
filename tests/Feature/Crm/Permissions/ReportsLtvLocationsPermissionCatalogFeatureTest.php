...
/**
 * reports.ltv.locations.view: видимое, в базовых admin/trainer, без backfill существующих партнёров.
 */
final class ReportsLtvLocationsPermissionCatalogFeatureTest extends CrmTestCase
{
    private const PERMISSION = 'reports.ltv.locations.view';

    private const DESCRIPTION = 'Отчёт «Платежи по объектам»';
    ...
    public function test_add_migration_does_not_touch_permission_role_on_up(): void
    {
        $src = (string) file_get_contents(base_path(
            'database/migrations/2026_09_18_085500_add_reports_ltv_locations_view_permission.php'
        ));
