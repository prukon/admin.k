...
/**
 * Каталог права schedule.trainerSalary.scheme.sales: скрытое, не в базовых ролях.
 */
final class TrainerSalarySchemeSalesPermissionCatalogFeatureTest extends CrmTestCase
{
    private const PERMISSION_NAME = 'schedule.trainerSalary.scheme.sales';

    private const DESCRIPTION = 'ЗП тренеров: схема «% от продаж» (оклад + процент от оплат учеников)';
    ...
    public function test_permission_exists_in_schedule_group_hidden(): void
    {
        ...
        $this->assertNotNull($row, 'Право schedule.trainerSalary.scheme.sales должно существовать');
        ...
        $this->assertSame(28, (int) $row->sort_order);
    }
