...
/**
 * [P2] UX: страница без scheduleSlots.view → правка названия (JS шлёт duration_days='')
 * → срок 45 остаётся, строка видна в DataTables без F5.
 *
 * @see LessonPackageAutoAttendanceWorkflowFeatureTest
 */
final class LessonPackageDurationWorkflowFeatureTest extends CrmTestCase
{
    ...
    public function test_edit_from_packages_page_without_duration_field_keeps_value_and_row_without_reload(): void
    {
        ...
        $unique = 'WF-duration-'.uniqid('', true);
        ...
        $this->assertSame(45, (int) $row['duration_days']);
