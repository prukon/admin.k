...
/**
 * [P2] UX: страница без права scheduleSlots.view → правка названия в модалке
 * (JS шлёт auto_attendance_enabled=0) → флаг остаётся, строка видна в DataTables без F5.
 *
 * @see LessonPackagesListWorkflowFeatureTest
 */
final class LessonPackageAutoAttendanceWorkflowFeatureTest extends CrmTestCase
{
    ...
    public function test_edit_from_packages_page_without_auto_attendance_checkbox_keeps_flag_and_row_without_reload(): void
    {
