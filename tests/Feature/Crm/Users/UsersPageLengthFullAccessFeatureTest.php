...
/**
 * [P1] Доступ к персональному «Показать N» на /admin/users: гость / без права / viewer / admin;
 * PUT/PATCH/DELETE не 500.
 *
 * @see \Tests\Feature\Crm\Teams\TeamControllerTest::test_store_non_ajax_redirects_and_creates_team
 * @see UsersPageLengthFeatureTest
 */
final class UsersPageLengthFullAccessFeatureTest extends CrmTestCase
{
    ...
    public function test_user_without_users_view_gets_403_on_page_length_endpoints(): void
    {
    ...
    public function test_viewer_with_users_view_can_save_show_by_and_sees_it_after_reload(): void
    {
    ...
    public function test_admin_can_save_show_by_via_ajax_and_non_ajax(): void
    {
        ...
        $nonAjax = $this->from(route('admin.user1'))
    ...
    public function test_unsupported_methods_on_columns_settings_do_not_save_page_length(): void
    {
        ...
        foreach (['PUT', 'PATCH', 'DELETE'] as $method) {
            $response = $this->json($method, route('admin.users.table-settings.save'), [
                'page_length' => 50,
            ]);
