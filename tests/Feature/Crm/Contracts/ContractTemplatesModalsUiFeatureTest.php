...
class ContractTemplatesModalsUiFeatureTest extends ContractsFeatureTestCase
{
    ...
    public function templates_index_renders_create_modal_with_form_and_variables_reference(): void
    {
        $this->get(route('contract-templates.index'))
            ...
            ->assertSee('Юр. лицо', false)
            ->assertSee('{{legal_entity_inn}}', false)
            ->assertSee('{{child_address}}', false)
            ->assertSee('{{child_passport}}', false)
            ->assertSee('{{child_passport_issued_at}}', false)
            ...
            ->assertSee('location_admin_emails', false)
            ->assertSee('location_admin_phones', false)
            ->assertSee('partner_email', false)
            ->assertSee('partner_phone', false)
            ->assertSee('partner_social_vk', false)
            ->assertSee('Соцсеть: VK', false)
            ->assertDontSee('partner_social_facebook', false)
