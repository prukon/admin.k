...
final class SessionLifetimeDocumentationContractTest extends TestCase
{
    public function test_doc_index_announces_session_lifetime_without_contradicting_live_ux(): void
    {
        ...
        $this->assertStringContainsString("env('SESSION_LIFETIME')", $chunk);
        ...
        $this->assertStringContainsString('204', $chunk);
        ...
        $this->assertStringContainsString('не 401', $chunk);
    ...
    public function test_session_lifetime_page_matches_code_contract(): void
    {
        ...
        $this->assertStringContainsString("env('SESSION_LIFETIME')", $html);
        ...
        $this->assertStringContainsString('204', $html);
        ...
        $this->assertStringContainsString('не 401', $html);
